...
public class CustomToast {
    ...
    /**
     * Show an info toast (dark background)
     */
    ...
    /**
     * Show a warning toast (yellow background)
     */
    ...
    public static void show(Context context, String message, Type type) {
        ...
        switch (type) {
            case SUCCESS:
                ...
                icon.setImageResource(R.drawable.ic_done_check);
                break;
            case ERROR:
                layout.setBackgroundResource(R.drawable.bg_toast_error);
                icon.setImageResource(R.drawable.ic_close_white);
                break;
            case INFO:
