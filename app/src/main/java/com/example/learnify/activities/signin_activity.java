...
public class signin_activity extends BaseActivity {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        try {
                            ...
                            // ✅ Replaced Toast
                            CustomToast.error(signin_activity.this, "Google Sign-In Failed");
                        }
                    } else {
                        // ✅ Replaced Toast
                        CustomToast.info(signin_activity.this, "Sign-In cancelled");
                    }
                }
            });
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, task -> {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            // ✅ Replaced Toast
                            CustomToast.error(signin_activity.this, "Authentication failed. Check credentials.");
                            updateUI(null);
                        }
                    });
        });
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        // ✅ Replaced Toast
                        CustomToast.error(signin_activity.this, "Authentication Failed.");
                        updateUI(null);
                    }
                });
    }
    ...
    private void updateUI(FirebaseUser user) {
        if (user != null) {
            ...
            // ✅ Replaced Toast
            CustomToast.success(this, "Signed in as: " + (user.getDisplayName() != null ? user.getDisplayName() : user.getEmail()));
