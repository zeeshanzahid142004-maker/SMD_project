...
public class signup_activity extends BaseActivity {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        try {
                            ...
                            // ✅ Replaced Toast
                            CustomToast.error(signup_activity.this, "Google Sign-In Failed");
                        }
                    } else {
                        // ✅ Replaced Toast
                        CustomToast.info(signup_activity.this, "Sign-In cancelled");
                    }
                }
            });
    ...
    void init() {
        ...
        // Set listener for Google button
            ...
            mAuth.createUserWithEmailAndPassword(email, password)
                    .addOnCompleteListener(this, task -> {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            // ✅ Replaced Toast
                            CustomToast.success(signup_activity.this, "Sign up successful!");

                            updateUI(user);
                        } else {
                            Log.w(TAG, "createUserWithEmail:failure", task.getException());
                            // ✅ Replaced Toast with safer error message
                            String errorMsg = task.getException() != null ? task.getException().getMessage() : "Unknown error";
                            CustomToast.error(signup_activity.this, "Authentication failed: " + errorMsg);
                        }
                    });
        });
    }
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        // ✅ Replaced Toast
                        CustomToast.error(signup_activity.this, "Authentication Failed.");
                    }
                });
    }
