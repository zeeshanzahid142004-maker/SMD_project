...
// Removed unused standard Toast import to keep it clean, or you can leave it.
...
import com.example.learnify.adapters.QuizReviewAdapter;
...
public class QuizReviewActivity extends BaseActivity {
    ...
    private void loadQuizQuestions() {
        if (quizId == null || quizId.isEmpty()) {
            // ✅ Replaced Toast
            CustomToast.error(this, "Quiz ID not found");
            return;
        }
        ...
        db.collection("quizzes").document(quizId)
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        if (quiz != null && quiz.getQuestions() != null) {
                            ...
                            // ✅ Replaced Toast
                            CustomToast.warning(this, "No questions found");
                        }
                    } else {
                        // ✅ Replaced Toast
                ...
                .addOnFailureListener(e -> {
                    ...
                    // ✅ Replaced Toast
                    CustomToast.error(this, "Failed to load quiz questions");
                });
    }
    ...
    private void setupQuestionsRecyclerView() {
        if (questions == null || questions.isEmpty()) {
            // ✅ Replaced Toast
            CustomToast.info(this, "No questions to display");
            return;
        }
    ...
    private void retakeQuiz() {
        if (quizId == null || quizId.isEmpty()) {
            // ✅ Replaced Toast
            CustomToast.error(this, "Cannot retake - Quiz ID missing");
            return;
        }
        ...
        db.collection("quizzes").document(quizId)
                ...
                .addOnFailureListener(e -> {
                    ...
                    // ✅ Replaced Toast
                    CustomToast.error(this, "Failed to load quiz");
                });
    }
}