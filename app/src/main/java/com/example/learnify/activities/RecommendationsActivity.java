...
// Removed standard Toast import

import androidx.activity.OnBackPressedCallback;
import androidx.annotation.Nullable;
import androidx.recyclerview.widget.LinearLayoutManager; // ✅ Needed for the list to show
...
import com.example.learnify.adapters.RecommendationAdapter;
import com.example.learnify.modelclass.RecommendationItem;
import com.example.learnify.services.RecommendationService;
...
public class RecommendationsActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // ✅ FIX: Force White Colors in Dark Mode
        ...
        // ✅ HANDLE TOOLBAR HOME BUTTON
        toolbar.setNavigationOnClickListener(v -> goToHome());
    ...
    // ✅ HELPER METHOD TO GO HOME AND CLEAR STACK
    ...
    private void setupRecommendations() {
        ...
        // ✅ CRITICAL FIX: Set LayoutManager so the list appears
    ...
    private void downloadQuiz() {
        if (quizId == null || incorrectQuestions == null) {
            // ✅ UPDATED TO CUSTOM TOAST
            CustomToast.error(this, "Cannot download quiz");
            return;
        }

        // ✅ UPDATED TO CUSTOM TOAST
        CustomToast.info(this, "⬇️ Downloading quiz...");
    ...
    private void markAsFavorite() {
        if (quizId == null) {
            // ✅ UPDATED TO CUSTOM TOAST
            CustomToast.error(this, "Cannot mark as favorite");
            return;
        }
        ...
        // ✅ UPDATED TO CUSTOM TOAST
        CustomToast.success(this, "❤️ Added to favorites!");
